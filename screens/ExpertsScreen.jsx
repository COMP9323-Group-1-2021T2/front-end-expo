...
export const ExpertsScreen = () => {
  ...
  const experts = [
    {
      email: "a.tillman@unsw.edu.au",
      name: "Alexandra Tillman",
      link: "https://www.linkedin.com/in/alexandra-tillman-7a2b534a/",
      number: "0414 398 808",
      description:
        "Experienced Health Safety Environment Officer with a demonstrated history of working in the Defence and education sectors. Skilled in ISO 14001, Emergency Management, Workplace Safety, Environmental Awareness, and Safety Management Systems. Strong operations professional graduated from University of Newcastle.",
    },
    {
      email: "m.mclaws@unsw.edu.au",
      name: "Marylouise McLaws",
      link: "https://www.linkedin.com/in/marylouise-mclaws-707a8533/",
      number: "(02) 9385 8765",
      description:
        "I am an epidemiologist in patient safety associated with infection prevention and outbreak with expertise in surveillance. I am currently (February 2020 - ) a member of the WHO Health Emergencies Program Experts Advisory Panel for Infection Prevention and Control Preparedness, Readiness and Response to COVID-19",
    },
    {
      email: "s.reppermund@unsw.edu.au",
      name: "Simone Reppermund",
      link: "https://www.linkedin.com/in/marylouise-mclaws-707a8533/",
      number: "+61 2 9931 9154",
      description:
        "I have a PhD in Psychology (2007, Max Planck Institute of Psychiatry and Ludwig Maximilian University Munich, Germany). I am a UNSW Scientia Fellow within the School of Psychiatry. My research interests are in the field of mental health, in particular depression in old age, intellectual disability, healthy ageing, as well as cognitive decline.",
    },
    {
      email: "t.clay@unsw.edu.au",
      name: "Theresa McDonnell",
      link: "https://www.linkedin.com/in/marylouise-mclaws-707a8533/",
      number: "02 9065 6349",
      description:
        "Leader in Work Health & Safety and Injury Management (IM) delivering sustainable improvements in large complex organisations.Track record in designing and implementing fit for purpose WHS and IM systems. Broad technical knowledge of WHS & IM legislation.Leading teams through significant change while maintaining a high level of service.",
    },
  ];
      ...
      >
        <View style={styles.container}>
          {experts.map((expert, i) => (
            <>
              <Card
                style={{ maxWidth: "600px", width: "100%", marginBottom: "2%" }}
              >
                <Card.Content>
                  <View
                    style={[
                      styles.cardContent,
                      screenWidth < 600 || windowWidth < 600
                        ? styles.flexColumn
                        : styles.flexRow,
                    ]}
                  >
                    ...
                    >
                      <Image
                        source={require(`../assets/experts/${i}.PNG`)}
                        resizeMode="contain"
